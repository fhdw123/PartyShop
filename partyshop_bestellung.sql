...
CREATE TABLE `bestellung` (
  `bestellungid` varchar(45) NOT NULL,
  `user` varchar(45) NOT NULL,
  `preis` double NOT NULL,
  `datum` varchar(45) NOT NULL,
  PRIMARY KEY (`bestellungid`),
  KEY `user_idx` (`user`),
  CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `user` (`userid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2016-11-12 16:02:00
